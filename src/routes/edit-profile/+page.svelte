...
<svelte:head>
  <title>Edit Profile | Auth App</title>
</svelte:head>
...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 relative overflow-hidden">
  ...
  <div class="absolute inset-0 overflow-hidden pointer-events-none">
    <div class="absolute top-10 left-5 w-40 h-40 bg-gradient-to-r from-blue-400 to-blue-600 rounded-full opacity-10 blur-3xl transform rotate-12 animate-pulse"></div>
    <div class="absolute top-20 right-10 w-32 h-32 bg-gradient-to-r from-indigo-400 to-purple-500 rounded-full opacity-8 blur-2xl transform -rotate-12 animate-pulse delay-1000"></div>
    <div class="absolute bottom-10 left-1/3 w-48 h-48 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full opacity-6 blur-3xl transform rotate-45 animate-pulse delay-2000"></div>
    <div class="absolute bottom-20 right-1/4 w-36 h-36 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full opacity-8 blur-2xl transform -rotate-30 animate-pulse delay-1500"></div>
    <div class="absolute top-1/2 left-1/2 w-64 h-64 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full opacity-4 blur-3xl transform -translate-x-1/2 -translate-y-1/2 animate-pulse delay-500"></div>
  </div>
  ...
  <div class="relative z-10 min-h-screen">
    <div class="max-w-4xl mx-auto px-8 py-12">
      ...
      <div class="bg-white/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20 mb-12 transform hover:scale-[1.02] transition-transform duration-500">
        <div class="flex justify-between items-center">
          <div class="flex items-center space-x-6">
            <div class="relative">
              <div class="w-20 h-20 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center shadow-xl transform rotate-2 hover:rotate-0 transition-transform duration-300">
                <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
              </div>
              <div class="absolute -top-1 -right-1 w-6 h-6 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full opacity-80 animate-pulse"></div>
            </div>
            <div>
      ...
      <div class="relative group">
        <div class="absolute inset-0 bg-gradient-to-br from-white/90 to-blue-50/90 rounded-3xl transform rotate-1 group-hover:rotate-0 transition-transform duration-500 shadow-2xl"></div>
        <div class="relative bg-white/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20">
          <div class="flex items-center mb-8">
            ...
            <h3 class="text-xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Account Information</h3>
          </div>
            ...
            <div class="space-y-6">
              ...
              <div class="flex space-x-4">
                <Button
                  ...
                  variant="primary"
                  loading={loading}
                  class="group relative overflow-hidden bg-gradient-to-r from-blue-500 to-indigo-600 text-white border-0 hover:from-blue-600 hover:to-indigo-700 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 rounded-lg px-6 py-3 font-semibold"
                >
